...
describe('PUT /lists/:id/reorder', () => {
    ...
    it('should return 200 if user & list are found', async () => {
        ...
        const mockList = { _id: listId, save: jest.fn(), boardId, order: "0", updatedAt: new Date(), save: jest.fn() };
        ...
        expect(res.body.newList.order).toEqual("1");
    });
});
