            ...
            >
                {(provided, snapshot) => (
                    <div
                        ...
                        className={`bg-gray-50 w-full group border-[2px] border-gray-600 px-2 py-3 flex flex-col mt-3 shadow-[0_2px_0_0] shadow-gray-600 relative ${theme.itemTheme == 'circle' ? 'rounded' : ''}`}
