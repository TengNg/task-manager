...
const HighlightPicker = ({ setOpen, card }) => {
    ...
    return (
        <div
            ...
            className="absolute z-10 top-0 left-0 -translate-x-[105%] flex flex-col gap-1 items-center justify-center bg-gray-200 p-2 border-[2px] border-black shadow-black shadow-[4px_5px_0_0] w-[200px]"
        >
