    ...
    return (
        <>
            <section className="w-full flex--center flex-col">
                ...
                <section className="div--style h-[auto] w-fit p-9 text-justify flex flex-col justify-center gap-4 my-[2rem] flex--center">
                ...
                <div className='w-[10rem] h-[5rem] flex--center'>
                    <button
